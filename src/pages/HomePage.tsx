...
const HomePage = () => {
  ...
  return (
    <>
      ...
      ctaLink="https://www.instagram.com/innovisio.n?igsh=OHoxZXdsb245bnpp"
      ...
      <div className="container-custom">
        ...
        <Link to="/courses" className="card p-6 flex flex-col items-center text-center hover:border-primary-500 hover:border-2 transition-all" target="_self">
        ...
        <Link to="/portfolio" className="card p-6 flex flex-col items-center text-center hover:border-primary-500 hover:border-2 transition-all" target="_self">
        ...
        <Link to="/jobs" className="card p-6 flex flex-col items-center text-center hover:border-primary-500 hover:border-2 transition-all" target="_self">
        ...
        <Link to="/community" className="card p-6 flex flex-col items-center text-center hover:border-primary-500 hover:border-2 transition-all" target="_self">
      ...
      <div className="container-custom">
        ...
        <Link to="/courses" className="btn btn-primary inline-flex items-center" target="_self">
          View All Courses
      ...
      <div className="container-custom">
        ...
        <div className="mb-8 md:mb-0 md:max-w-xl">
          ...
          <Link to="/events" className="btn bg-white text-primary-900 hover:bg-gray-100" target="_self">
          Learn More
          </Link>
        </div>
      ...
      <div className="container-custom">
        ...
        <div className="card p-8">
          ...
          <p className="text-gray-600">Students Joined In Our Community</p>
        </div>
